...
int board_early_init_f(void)
{
	...
	mxs_iomux_setup_pad(MX28_PAD_SAIF0_SDATA0__GPIO_3_23);
	mxs_iomux_setup_pad(MX28_PAD_SAIF1_SDATA0__GPIO_3_26);
...
int board_mmc_init(bd_t *bis)
{
	...
	return mxsmmc_initialize(bis, 0, NULL, mx28evk_mmc_cd);
}
#endif
